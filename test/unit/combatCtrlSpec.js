...
describe("CombatCtrl", function () {
    ...
    it("should inject ", inject(function (_$httpBackend_, $rootScope, $controller, midgard) {
        var ctrl;
        var scope;
    ...
    //    module("midgardApp");
    //
    //    inject(function (_$httpBackend_, _midgard_, $rootScope, $controller) {
    ...
    //        midgard = _midgard_;
    //
    //        midgard['$inject'] = ['$httpBackend'];
    //
    //        scope = $rootScope.$new();
    //        dump('injecting into controller');
    //
    ...
    //
    //    iit("should get data from midgard service", function () {
    //        inject(function (midgard, $httpBackend) {
    //            $httpBackend.expectGET('combats/group.json').
    //                respond({
    //                    "groupList": [{
    //                        "name": "Die Guten",
    ...
    //    //    expect(scope.data.groupList).toBeDefined();
